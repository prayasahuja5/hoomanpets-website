        ...
        <div className="container-max section-padding py-12 md:py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 lg:gap-12 mb-12">
            ...
            <div className="space-y-6">
                          <h3 className="font-bold text-hooman-black">
              ...
              <form onSubmit={handleSubscribe} className="flex items-end gap-4">
                ...
                <button
                  ...
                  className="bg-hooman-black text-white px-6 py-2 rounded-full font-bold hover:bg-hooman-black/90 hover:shadow-md transition-all duration-300 disabled:opacity-50"
                >
          ...
          <div className="border-t border-hooman-black pt-8">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-3">
                <div className="relative w-32 h-8 hover:scale-105 transition-transform duration-300">
                  <Image
